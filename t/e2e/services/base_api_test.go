...
func (s *BaseJSONRPCSuite) SetupTest(upstreamEnabled, statusServiceEnabled, debugAPIEnabled bool) error {
	...
	nodeConfig.StatusServiceConfig.Enabled = statusServiceEnabled
	nodeConfig.StatusServiceConfig.Debug = debugAPIEnabled
	if nodeConfig.StatusServiceConfig.Debug {
